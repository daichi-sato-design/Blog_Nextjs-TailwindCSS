    ...
    <Layout title="Contact">
      <div className="bg-white text-center shadow-xl p-8 w-80 rounded">
        ...
        <div className="mt-4">
          ...
          <p className="text-xs mt-2 text-gray-600">nextjs@example.com</p>
          <p className="font-bold mt-3">Phone</p>
          <p className="text-xs mt-2 text-gray-600">000-8888-1111</p>
        </div>
        <div className="mt-6 flex justify-center">
          ...
          <div>
            <a
              href="https://www.facebook.com/profile.php?id=100016189206932"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
